...
for (let i = 0; i < inventory.length; i++){
    if (inventory[i].id === 33) {
      var car_year = inventory[i].car_year;
      var car_make = inventory[i].car_make;
      var car_model = inventory[i].car_model;
    }
}
...
console.log(`The last car is a ${lastCar.car_make} and ${lastCar.car_model}`);
